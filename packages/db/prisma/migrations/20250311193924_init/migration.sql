...
-- CreateEnum
CREATE TYPE "EhnicityTypeEnum" AS ENUM ('Black', 'white', 'AsianAmerican', 'EastAsian', 'SouthEastAsian', 'SouthAsian', 'MiddleEastern', 'Pacific', 'Hispanic');
...
CREATE TABLE "Model" (
    ...
    "ethnicity" "EhnicityTypeEnum" NOT NULL,
